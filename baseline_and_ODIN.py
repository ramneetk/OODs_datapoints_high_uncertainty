...
parser.add_argument('--net_type', required=True, default='resnet34', help='resnet | densenet')
...
def main():
    ...
    if args.dataset == 'svhn':
        ...
        out_dist_list = ['svhn', 'imagenet_resize', 'lsun_resize', 'cifar100', 'places365']
    ...
    for T in T_list:
        for m in M_list:
            magnitude = m
            temperature = T
            lib_generation.get_posterior(model, args.net_type, test_loader, magnitude, temperature, args.outf, True, device='cuda:0')
            out_count = 0
            ...
            for out_dist in out_dist_list:
                ...
                lib_generation.get_posterior(model, args.net_type, out_test_loader, magnitude, temperature, args.outf, False, device='cuda:0')
